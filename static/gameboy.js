...
fetch('zelda.gb')
    ...
    .then(arrayBuffer => {
        ...
        if (!ctx) return;
        var rom = new __WEBPACK_IMPORTED_MODULE_1__src_rom_js__["a" /* default */](new Uint8Array(arrayBuffer));
        var cpu = new __WEBPACK_IMPORTED_MODULE_0__src_cpu_js__["a" /* default */](rom);
        var video = new __WEBPACK_IMPORTED_MODULE_2__src_video_js__["a" /* default */](rom, ctx);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__opcodes_js__ = __webpack_require__(2);
...
class CPU {
    ...
    tick() {
        ...
        var op = __WEBPACK_IMPORTED_MODULE_0__opcodes_js__["b" /* opcodeMap */][address];
        if (this.cb) {
            op = __WEBPACK_IMPORTED_MODULE_0__opcodes_js__["a" /* cbOpcodeMap */][address];
            this.cb = false;
        }
        this.printState(op);
        op(this);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return opcodeMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return cbOpcodeMap; });
var opcodeMap = [
...
/* harmony default export */ __webpack_exports__["a"] = (ROMFile);
